...
ser = serial.Serial(port = "/dev/ttyACM0", baudrate = 57600fd, timeout = 0.1)
i2c = board.I2C()    
...
hopping_count = 0
global points
points = [[35.2320919,129.079303],[35.2320661,129.079259]]
    ...
    while True:
        ...
        if res == None:
            ...
            if (res == "checksum error"):
                ...
                longitude = lon_h + (lon_m/60)
                print('latitude: %f longitude: %f' %(latitude,longitude))
                fourth,bearing = Optimal(latitude,longitude,points[hopping_count][0],points[hopping_count][1])
                cnt += 1
    ...
    while True:
        ...
        if res == None:
            ...
            if (res == "checksum error"):
                ...
                if (range < 2.3):  # stop front start behind wheel 
                    hopping_count += 1
                    kit.servo[0].angle = 20
                    kit.servo[1].angle = 180
                    time.sleep(0.4)
